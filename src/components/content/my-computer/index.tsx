...
const fieldsetWrapperClass = '[&>legend]:text-violet-500 [&>legend]:text-xs md:[&>legend]:text-sm';
  ...
  return (
    <div className='border border-gray-500 bg-[#C0C0C0] h-full flex flex-col font-mono text-black selection:bg-[#000080] selection:text-white'>
      <div className='p-4 sm:p-6 flex-1 overflow-auto'>
        <h2 className='text-base md:text-lg font-bold text-sky-500 mb-6'>MY COMPUTER</h2>
        ...
        <div className='mt-8 md:mt-12 flex justify-end'>
          <RetroButton onClick={onClose} className='min-w-20 text-xs md:text-sm'>
            OK
          </RetroButton>
        </div>
      </div>
